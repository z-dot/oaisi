...
- **Control reading group**: (currently full) following this [syllabus](https://docs.google.com/document/d/1T7bzAI38VJdKOYSdZSWVq2BOESWghMsFeVtCFc57toA/preview). If you'd be interested to set up your own small AI safety-related reading group, please let us know with [this form](https://forms.gle/MpPYCWAEn32BZepb8), and we'd be excited to chat!
